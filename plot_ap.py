...
if __name__ == '__main__':
    ...
    _, _, _, map_obj2class = pickle.load(
        open(os.path.join(args.base_dir, 'misc.pkl'), 'rb'))
    ...
    data = {
        # "0":"_split_mode_i_split_idx_0",
        "1":"_split_mode_i_split_idx_1",
        # "2":"_split_mode_i_split_idx_2",
        # "3":"_split_mode_i_split_idx_3",
    }
    exp_name = 'gcngrasp_o'
